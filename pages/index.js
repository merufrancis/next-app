    ...
    <div>
      ...
      <main className=" bg-white px-10 dark:bg-gray-900 md:px-20 lg:px-40">
        <section className="min-h-screen">
          ...
          <button className="bg-gradient-to-r from-cyan-500 text- to-red-500 text-white px-4 py-2 border-none rounded-md ml-8">
            <Link href="https://drive.google.com/file/d/1VhRjKpltJG_tvol_6D9uPaTYAoli25PK/view?usp=sharing">Download Resume</Link>
          </button>
        ...
        <section>
          ...
          <div className="lg:flex gap-10">
            ...
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white flex-1">
              ...
              <h3 className="text-lg font-medium pt-8 pb-2 ">QA Engineer</h3>
              <p className="py-2">
                Are you interested in testing for your current project? I can
                give you tips and tricks to level it up.
              </p>
              <h4 className="py-4 text-teal-600">Design Tools I Use</h4>
              <p className="text-gray-800 py-1">Sellenium</p>
              <p className="text-gray-800 py-1">Jest</p>
              <p className="text-gray-800 py-1">Cypress</p>
              <p className="text-gray-800 py-1">Mocha</p>
            </div>
          </div>
        </section>
      </main>
